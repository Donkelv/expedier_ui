  ...
  void showSuccessSnackBar({required String message, VoidCallback? onDismiss}) {
    ScaffoldMessenger.of(this).showSnackBar(
      SnackBar(
        ...
        backgroundColor: ExpedierColors.green2,
        behavior: SnackBarBehavior.floating,
        shape: RoundedRectangleBorder(
          side: BorderSide(color: ExpedierColors.green2, width: 1),
  ...
  void showErrorSnackBar({required String message, VoidCallback? onDismiss}) {
    ScaffoldMessenger.of(this).showSnackBar(
      SnackBar(
        ...
        backgroundColor: ExpedierColors.primary.withOpacity(0.6),
        behavior: SnackBarBehavior.floating,
        shape: RoundedRectangleBorder(
          side: BorderSide(
            color: ExpedierColors.primary.withOpacity(0.6),
            width: 1,
          ),
